...
//
//        teacherEntity.setJob(requestDto.getJob());
//        teacherEntity.setBio(requestDto.getBio());
//        teacherEntity.setPicture(requestDto.getPicture());
...
//        teacherEntity.setAttendanceStatuses(requestDto.getAttendanceStatuses());
//        teacherEntity.setAttendanceGrades(requestDto.getAttendanceGrades());
//
//        teacherEntity = teacherRepository.save(teacherEntity);
//        return teacherMapper.toDto(teacherEntity);
//    }
